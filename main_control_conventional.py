...
def run_control_loop(modules: Dict[str, object], duration: Optional[float] = None) -> None:
    ...
    # Get torque limits for utilization calculation
    ...
    try:
        while running:
            ...
            # For M1 we applied tau1_cmd. For M2 we applied tau2_cmd (which results in some torque).
            ...
            logger.log(
                ...
                reference_position,
                reference_velocity,
                reference_position,  # theta_ctrl
                tau_ctrl,
                tau_aug,
                dob_diag.get("filtered_disturbance", 0.0),
                tau_aug,  # tau_out
